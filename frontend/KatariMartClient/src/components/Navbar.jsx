...
function Navbar({cart, removeFromCart, increaseQuantity, decreaseQuantity, cartCount}) {
...
return (
  ...
  <a href="#" role="button" class="relative flex">
    <svg class="flex-1 w-8 h-8 fill-current" viewbox="0 0 24 24" >
      ...
      <span class="absolute right-0 top-0 rounded-full bg-purple-600 w-4 h-4 top right p-0 m-0 text-white font-mono text-sm  leading-tight text-center">{cartCount}
    </span>
  </a>
</li>
    </span>
