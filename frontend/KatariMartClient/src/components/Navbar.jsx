  ...
  <a href="#" role="button" class="relative flex">
    <svg class="flex-1 w-8 h-6 mb-2 fill-current" viewbox="0 0 24 24" >
      ...
      <button
        ...
        className="flex items-center px-3 py-2 rounded hover:-400"
      >
        <svg
    ...
    >
      <div className="text-sm lg:flex-grow text-center mr-40">
        ...
        <div
  className="mt-4 lg:inline-block lg:mt-0  font-bold text-lg hover:font-thin hover:border-b-2 hover:border-b-purple-700 mr-4 cursor-pointer">
