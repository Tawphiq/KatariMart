...
const Banner = () => {
  ...
  return (
    <div data-aos="fade-left" className='bg-[url(./assets/slider-bg.jpg)] text-white h-96 bg-cover bg-right lg:bg-top bg-no-repeat lg:bg-contain lg:h-screen'>
      ...
      <p data-aos="fade-down-left" className='flex px-12 py-5 lg:px-20 font-bold'>Elevate Your Style with Exquisite Timepieces - Explore Our Online Watch Shop Today!</p>
