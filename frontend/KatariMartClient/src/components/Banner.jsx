...
const Banner = () => {
  ...
  return (
    <div data-aos="fade-left" className='bg-[url(./assets/slider-bg.jpg)] text-white h-96 bg-cover bg-center lg:bg-top bg-no-repeat lg:bg-contain lg:h-screen lg:bg-no-repeat'>
      <h1 className='text-4xl text-white font-bold font-mono flex justify-center lg:text-5xl lg:justify-start px-20'><span data-aos="fade-down-right" className='mt-20 lg:mt-40'>STYLE WATCHES</span></h1>
