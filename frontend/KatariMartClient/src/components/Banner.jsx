...
const Banner = () => {
  ...
  return (
    <div data-aos="fade-left" className='bg-[url(./assets/slider-bg.jpg)] text-white h-96 bg-cover bg-right lg:bg-top bg-no-repeat lg:bg-contain lg:h-screen lg:bg-no-repeat'>
